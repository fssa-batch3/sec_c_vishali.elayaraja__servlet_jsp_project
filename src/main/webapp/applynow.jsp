...
<body>
	...
	%>
	<div class="container">
		<span class="big-circle"></span> <img src="https://iili.io/JJAAPwb.png"
			class="square" alt="icon" />
		...
		<form action="ApplyNowServlet" method="post" class="form">
			...
			<div class="column">
				<div class="input-box">
					<label for="mobileNumber">Phone Number</label> <input type="number"
						placeholder="Enter phone number" name="mobileNumber"
						value="<%=student.getMobileNumber()%>" required />
				</div>
				<div class="input-box">
	 ...
	 <div class="exit">
      <span href="./home.jsp" class="fa-solid fa-circle-arrow-left" style="color: #0e1010;"></span>
     </div>
